...
def create_agents():
    """
    Factory function to create FRESH instances of agents for every run.
    This prevents 'Parent already assigned' errors during testing.
    """
    ...
    return research_agent, strategist_agent, generator_agent
